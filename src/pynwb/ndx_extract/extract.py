...
class EXTRACTSegmentation(ImageSegmentation):
    ...
    __nwbfields__ = ('version', 'preprocess', 'pre_mask_on', 'pre_mask_radius',
                     'fix_zero_FOV_strips', 'medfilt_outlier_pixels', 'skip_dff',
                     'second_df', 'skip_highpass', 'spatial_highpass_cutoff',
                     'temporal_denoising', 'remove_background', 'use_default_gpu',
                     'use_gpu', 'multi_gpu', 'parallel_cpu', 'avg_cell_radius',
                     'avg_event_tau', 'avg_yield_threshold', 'num_partitions_x',
                     'num_partitions_y', 'trace_output_option', 'trace_quantile',
                     'dendrite_aware', 'crop_circular', 'use_sparse_arrays', 'verbose',
                     'compact_output', 'hyperparameter_tuning_flag',
                     'remove_duplicate_cells', 'max_iter', 'minimal_checks',
                     'cellfind_min_snr', 'cellfind_max_steps', 'cellfind_kappa_std_ratio',
                     'cellfind_filter_type', 'cellfind_numpix_threshold',
                     'cellfind_adaptive_kappa', 'cellfind_spatial_highpass_cutoff',
                     'moving_radius', 'moving_radius_spatial', 'moving_radius_temporal',
                     'init_with_gaussian', 'high2low_brightness_ratio',
                     'visualize_cellfinding', 'visualize_cellfinding_full_range',
                     'visualize_cellfinding_max', 'visualize_cellfinding_min',
                     'visualize_cellfinding_show_bad_cells', 'kappa_std_ratio',
                     'T_dup_corr_thresh', 'T_dup_thresh', 'S_dup_corr_thresh',
                     'S_corr_thresh', 'T_corr_thresh', 'temporal_corrupt_thresh',
                     'spatial_corrupt_thresh', 'T_min_snr', 'size_lower_limit',
                     'size_upper_limit', 'eccent_thresh', 'low_ST_index_thresh',
                     'low_cell_area_flag', 'high_ST_index_thresh',
                     'low_ST_corr_thresh', 'confidence_thresh', 'downsample_time_by',
                     'min_tau_after_downsampling', 'downsample_space_by',
                     'min_radius_after_downsampling', 'reestimate_S_if_downsampled',
                     'reestimate_T_if_downsampled', 'adaptive_kappa', 'arbitrary_mask',
                     'smoothing_ratio_x2y', 'spatial_lowpass_cutoff', 'smooth_T',
                     'smooth_S', 'l1_penalty_factor', 'max_iter_S', 'max_iter_T',
                     'TOL_sub', 'TOL_main', 'T_lower_snr_threshold', 'save_all_found',
                     'plot_loss', 'baseline_quantile', 'S_init', 'T_init', 'movie_mask',
                     'is_pixel_valid', 'num_frames', 'num_iter_stop_quality_checks', 'pick_gpu')
